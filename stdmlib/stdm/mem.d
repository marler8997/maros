...
version (NoStdc)
{
    version (linux)
    {
        import stdm.linux.mem : sbrk;
    }
    else static assert(0, "unsupported platform");

    // TODO: replace this with the standard c library implementation
    ...
    static this()
    {
        version (linux)
        {
            import stdm.linux.file; write(stdout, "[DEBUG] stdlib static this!\n");
