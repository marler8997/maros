module stdm.linux.file;

import stdm.typecons : ValueOrErrorCode;
import stdm.wrap;
import stdm.c;
import stdm.linux.cthunk;
...
struct FileD
{
    ...
    private this(typeof(_value) value) pure nothrow @nogc
    {
        this._value = value;
    }
    ...
    {
        import stdm.format : printDecimal;
...
{
    import stdm.format : DefaultBufferedFilePrinterPolicy, BufferedFilePrinter, argsToPrinter;
